...
exports.getAllTransactionValidate = getAllTransactionValidate;
exports.getAllTransactionValidation = getAllTransactionValidation;
...
function getAllTransactionValidate(getAllTransactionValidation) {
    return (req, _res, next) => __awaiter(this, void 0, void 0, function* () {
        try {
            const validatedData = yield getAllTransactionValidation(req.body);
...
function getAllTransactionValidation(data) {
