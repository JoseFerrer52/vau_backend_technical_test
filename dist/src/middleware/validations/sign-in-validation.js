...
exports.singInValidate = singInValidate;
exports.createSingInValidation = createSingInValidation;
...
function singInValidate(createSingInValidation) {
    return (req, _res, next) => __awaiter(this, void 0, void 0, function* () {
        try {
            const validatedData = yield createSingInValidation(req.body);
...
function createSingInValidation(data) {
