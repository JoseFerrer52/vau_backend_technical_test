...
exports.createFormdeleteUserValidation = createFormdeleteUserValidation;
const yup = __importStar(require("yup"));
const class_validation_error_1 = require("../../utilities/class_error/class-validation-error");
function validateDeleteUser(createFormdeleteUserValidation) {
    return (req, _res, next) => __awaiter(this, void 0, void 0, function* () {
        try {
            const validatedData = yield createFormdeleteUserValidation(req.body);
...
function createFormdeleteUserValidation(data) {
