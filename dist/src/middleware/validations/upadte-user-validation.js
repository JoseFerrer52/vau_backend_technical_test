...
exports.validateUpadteUser = validateUpadteUser;
exports.createFormUpadteUserValidation = createFormUpadteUserValidation;
const yup = __importStar(require("yup"));
const class_validation_error_1 = require("../../utilities/class_error/class-validation-error");
function validateUpadteUser(createFormUpadteUserValidation) {
    return (req, _res, next) => __awaiter(this, void 0, void 0, function* () {
        try {
            const validatedData = yield createFormUpadteUserValidation(req.body);
...
function createFormUpadteUserValidation(data) {
